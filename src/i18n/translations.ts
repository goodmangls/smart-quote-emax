...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     'landing.verifiedCarriers.desc': '36개 국내 지사망을 보유한 이맥스만의 강력한 물류 인프라를 통해 안전하고 신속한 배송을 보장합니다.',
  ...
  en: {
    ...
    'landing.subtitle': 'E-MAX Worldwide Express - A company doing its best for customers with integrity and credit. Express shipping solutions for global logistics partners. Calculate Door-to-Door costs instantly.',
    ...
    'landing.verifiedCarriers.desc': 'A powerful logistics infrastructure with 36 domestic branch offices across Korea, ensuring safe and rapid delivery.',
