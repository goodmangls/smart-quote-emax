...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'auth.magicLink.title': '매직 링크로 로그인',
    ...
    'auth.magicLink.noticeTitle': '비밀번호 없는 로그인이 기본입니다.',
    'auth.magicLink.noticeBody':
      '회사 이메일을 입력하고 전송된 일회성 보안 링크로 로그인하세요. 링크는 15분 후 만료되며 한 번만 사용할 수 있습니다.',
  ...
  en: {
    ...
    'auth.magicLink.noticeTitle': 'Password-free sign-in is now the default.',
    'auth.magicLink.noticeBody':
      'Enter your company email and use the one-time secure link we send. It expires in 15 minutes and can only be used once.',
