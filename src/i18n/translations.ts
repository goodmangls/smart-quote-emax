...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    // Quote comparison (/compare)
    'compare.subtitle':
      '여러 운송사와 할인율 조합으로 실시간 견적을 나란히 비교합니다. 슬롯마다 해당 운송사 기본 유류할증률(FSC)이 적용됩니다.',
    'compare.reset': '초기화',
    'compare.bestPrice': '최적가',
    'compare.carrierLabel': '운송사',
    'compare.carrierUps': 'UPS Worldwide',
    'compare.carrierDhl': 'DHL Express',
    'compare.carrierFedex': 'FedEx International',
    'compare.carrierEmax': 'EMAX (베트남·중국 노선)',
    'compare.carrierOcs': 'OCS (아시아 중심)',
    'compare.discountLabel': '할인율',
    'compare.discountMin': '최소 0%',
    'compare.discountMax': '최대 90%',
    'compare.finalQuote': '예상 최종 견적',
    'compare.rowBase': '국제 구간 순운임(베이스)',
    'compare.rowFsc': '유류할증료 (FSC)',
    'compare.rowOther': '할증·부가비 (기타)',
    'compare.rowChargeable': '과금 중량',
    'compare.transitUnknown': '배송 소요시간 정보 없음',
    'compare.unavailable': '선택하신 조건으로 견적을 산출할 수 없습니다.',
    'compare.table.title': '항목별 상세 비교',
    'compare.table.live': '실시간',
    'compare.table.metric': '항목',
    'compare.table.chargeable': '과금 중량',
    'compare.table.intlBase': '국제 순운임',
    'compare.table.fsc': '유류할증료 (FSC)',
    'compare.table.addons': '애드온·할증',
    'compare.table.grandTotal': '합계 (KRW)',
    'compare.mobile.swipeSlots': '← 좌우로 밀어 세 슬롯을 비교하세요',
    'compare.slotsRegionAria': '운임사별 견적 비교 슬롯 세 개',

    // Landing Page
    'landing.title.main': '250+개국 국제 운임,',
    'landing.title.sub': '1초 만에 견적 완료.',
    'landing.subtitle':
      '정직과 신용으로 고객에게 최선을 다하는 기업, 이맥스 국제특송(E-MAX)의 스마트 견적 시스템입니다. 전 세계 250+개국 Door-to-Door 운임을 실시간 환율과 FSC를 반영하여 즉시 산출합니다.',
    ...
    'landing.globalPorts': '250+ 국가 커버리지',
    ...
    'auth.error403': '접근이 거부되었습니다.',
    'auth.error429': '시도 횟수가 너무 많습니다. 잠시 후 다시 시도해주세요.',
    'auth.error500': '서버 오류가 발생했습니다.',
    'auth.networkError': '네트워크 오류가 발생했습니다.',
    'auth.loginFailed': '로그인에 실패했습니다.',
    'auth.registerFailed': '회원가입에 실패했습니다.',
    'auth.passwordUpdateFailed': '비밀번호 변경에 실패했습니다.',
    ...
    'auth.signinLoading': '로그인 중...',
    'auth.loginDescription': '이메일과 비밀번호로 로그인하세요.',
    'auth.magicLink.description': '이메일로 안전한 로그인 링크를 보내드립니다.',
    'auth.magicLink.title': '비밀번호 없이 로그인',
    'auth.magicLink.subtitle':
      '비밀번호를 잊으셨거나 간편하게 로그인하고 싶으시면 이메일 링크를 이용하세요.',
    'auth.magicLink.emailLabel': '이메일 주소',
    'auth.magicLink.emailRequired': '이메일을 입력해 주세요.',
    ...
    'auth.magicLink.noticeTitle': '비밀번호 입력 없이 안전하게 로그인',
    'auth.magicLink.noticeBody':
      '회사 이메일을 입력하면 일회성 보안 로그인 링크를 보내드립니다. 링크는 15분 후 만료되며 한 번만 사용할 수 있습니다.',
    ...
    'widget.exchange.fxDrift.title': '기준환율 재검토 필요',
    'widget.exchange.fxDrift.near': '기준환율 경계 근접',
    'widget.exchange.fxDrift.action': '하나은행 송금환율을 확인하고 FX UPDATE 를 진행하세요.',
  ...
  en: {
    ...
    // Quote comparison (/compare)
    'compare.subtitle':
      "Compare up to three carrier and discount combinations side by side. Each slot uses that carrier's default fuel surcharge (FSC), matching the main calculator.",
    'compare.reset': 'Reset',
    'compare.bestPrice': 'Best price',
    'compare.carrierLabel': 'Carrier',
    'compare.carrierUps': 'UPS Worldwide',
    'compare.carrierDhl': 'DHL Express',
    'compare.carrierFedex': 'FedEx International',
    'compare.carrierEmax': 'EMAX (CN / VN)',
    'compare.carrierOcs': 'OCS (Asia focus)',
    'compare.discountLabel': 'Discount',
    'compare.discountMin': 'Min (0%)',
    'compare.discountMax': 'Max (90%)',
    'compare.finalQuote': 'Estimated final quote',
    'compare.rowBase': 'International base',
    'compare.rowFsc': 'Fuel surcharge (FSC)',
    'compare.rowOther': 'Other surcharges & add-ons',
    'compare.rowChargeable': 'Chargeable weight',
    'compare.transitUnknown': 'No transit-time info',
    'compare.unavailable': 'Cannot calculate a quote for the selected combination.',
    'compare.table.title': 'Detailed comparison',
    'compare.table.live': 'Live',
    'compare.table.metric': 'Metric',
    'compare.table.chargeable': 'Chargeable weight',
    'compare.table.intlBase': 'International base rate',
    'compare.table.fsc': 'Fuel surcharge (FSC)',
    'compare.table.addons': 'Add-ons & surcharges',
    'compare.table.grandTotal': 'Grand total (KRW)',
    'compare.mobile.swipeSlots': 'Swipe sideways to compare all three slots',
    'compare.slotsRegionAria': 'Three carrier quote comparison slots',

    // Landing Page
    'landing.title.main': 'Freight Quotes for',
    'landing.title.sub': '250+ Countries, Instantly.',
    'landing.subtitle':
    ...
    'landing.globalPorts': '250+ Countries Covered',
    ...
    'auth.error403': 'Access denied.',
    'auth.error429': 'Too many attempts. Please wait a moment and try again.',
    'auth.error500': 'Server error.',
    ...
    'auth.magicLink.title': 'Password-free sign-in',
    'auth.magicLink.subtitle':
      'Forgot your password or prefer a simpler login? Use an email link instead.',
    ...
    'auth.magicLink.sendButton': 'Email me a sign-in link',
    ...
    'auth.magicLink.noticeTitle': 'Secure, password-free sign-in',
    'auth.magicLink.noticeBody':
      'Enter your company email and we\u2019ll send a one-time secure link. It expires in 15 minutes and can only be used once.',
    ...
    'quote.switch': 'Switch',
    'quote.totalQuote': 'Total Quote',
    'quote.zone': 'Zone',
    'quote.transit': 'Transit',
    'quote.actualWeight': 'Act. Weight',
    'quote.billableWeight': 'Bill. Weight',
    'quote.toggleCurrency': 'Toggle currency',
    ...
    'widget.exchange.fxDrift.title': 'Quoting rate needs review',
    'widget.exchange.fxDrift.near': 'Approaching the quoting-rate boundary',
    'widget.exchange.fxDrift.action': 'Check the Hana Bank remittance rate and run FX UPDATE.',
