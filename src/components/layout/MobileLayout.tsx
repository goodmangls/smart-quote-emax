              ...
              <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="flex items-center bg-emax-600 text-white px-3 py-2 rounded-xl text-xs font-bold shadow-lg shadow-emax-600/25 hover:bg-emax-500 active:scale-95 transition-all"
                    >
                      {t('calc.viewDetails')}
