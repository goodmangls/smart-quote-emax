export const inputStyles = {
    inputClass: (isMobileView: boolean) => `w-full border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:border-emax-500 focus:ring-emax-500 border bg-white dark:bg-gray-700 dark:text-white transition-colors placeholder-gray-400 ${isMobileView ? 'text-base py-3.5 px-4' : 'text-sm py-2 px-3'}`,
