    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 rounded-2xl p-6 sm:p-8 text-white">
      ...
      <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="group inline-flex items-center gap-2 bg-emax-600 hover:bg-emax-500 text-white font-semibold text-sm px-5 py-2.5 rounded-xl shadow-lg shadow-emax-600/25 hover:shadow-emax-500/30 transition-all active:scale-95"
        >
