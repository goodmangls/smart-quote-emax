...
export const DEFAULT_FSC_PERCENT = 50.25; // UPS default, effective 2026-06-01
export const DEFAULT_FSC_PERCENT_DHL = 48.75; // DHL default, effective 2026-06-01
export const DEFAULT_FSC_PERCENT_FEDEX = 49.25; // FedEx default, effective 2026-06-01
