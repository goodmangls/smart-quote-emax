...
export const DEFAULT_FSC_PERCENT_DHL = 42.0; // DHL default, effective 2026-08-17
export const DEFAULT_FSC_PERCENT_FEDEX = 43.5; // FedEx default, effective 2026-08-17
