...
export const DEFAULT_FSC_PERCENT_DHL = 40.25; // DHL default, effective 2026-08-10~08-16
export const DEFAULT_FSC_PERCENT_FEDEX = 46.0; // FedEx default, effective 2026-08-10
