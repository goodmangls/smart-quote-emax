...
export const DEFAULT_FSC_PERCENT = 44.75; // UPS default, effective 2026-07-27
export const DEFAULT_FSC_PERCENT_DHL = 38.75; // DHL default, effective 2026-07-27
export const DEFAULT_FSC_PERCENT_FEDEX = 44.00; // FedEx default, effective 2026-07-27
