...
export const DEFAULT_FSC_PERCENT = 46.25; // UPS default, effective 2026-08-03
export const DEFAULT_FSC_PERCENT_DHL = 38.25; // DHL default, effective 2026-08-03
export const DEFAULT_FSC_PERCENT_FEDEX = 45.50; // FedEx default, effective 2026-08-03
