...
export const DEFAULT_FSC_PERCENT = 40.50; // UPS default, effective 2026-07-20
export const DEFAULT_FSC_PERCENT_DHL = 38.50; // DHL default, effective 2026-07-20
export const DEFAULT_FSC_PERCENT_FEDEX = 39.75; // FedEx default, effective 2026-07-20
