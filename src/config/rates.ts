...
export const DEFAULT_FSC_PERCENT = 49.25; // UPS default, effective 2026-05-11
export const DEFAULT_FSC_PERCENT_DHL = 46.75; // DHL default, effective 2026-05-11
export const DEFAULT_FSC_PERCENT_FEDEX = 47.5; // FedEx default, effective 2026-05-11
