...
export const DEFAULT_FSC_PERCENT = 46.75; // UPS default, effective 2026-08-10
export const DEFAULT_FSC_PERCENT_DHL = 40.25; // DHL default, effective 2026-08-10
export const DEFAULT_FSC_PERCENT_FEDEX = 46.00; // FedEx default, effective 2026-08-10
