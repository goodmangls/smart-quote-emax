...
export const DEFAULT_FSC_PERCENT = 43.25; // UPS default, effective 2026-06-08
export const DEFAULT_FSC_PERCENT_DHL = 48.75; // DHL default, effective 2026-06-08
export const DEFAULT_FSC_PERCENT_FEDEX = 42.50; // FedEx default, effective 2026-06-08
