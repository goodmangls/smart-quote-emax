...
export const DEFAULT_FSC_PERCENT = 39.25; // UPS default, effective 2026-06-29
export const DEFAULT_FSC_PERCENT_DHL = 42.75; // DHL default, effective 2026-06-29
export const DEFAULT_FSC_PERCENT_FEDEX = 38.50; // FedEx default, effective 2026-06-29
