...
export const DEFAULT_FSC_PERCENT = 39.0; // UPS default, effective 2026-07-06
export const DEFAULT_FSC_PERCENT_DHL = 40.75; // DHL default, effective 2026-07-06
export const DEFAULT_FSC_PERCENT_FEDEX = 38.25; // FedEx default, effective 2026-07-06
