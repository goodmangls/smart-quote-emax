...
export const DEFAULT_FSC_PERCENT = 39.25; // UPS default, effective 2026-07-13
export const DEFAULT_FSC_PERCENT_DHL = 39.75; // DHL default, effective 2026-07-13
export const DEFAULT_FSC_PERCENT_FEDEX = 38.50; // FedEx default, effective 2026-07-13
export const DEFAULT_FSC_PERCENT_OCS = 25.0; // OCS default, effective 2026-07-13
