...
export const DEFAULT_FSC_PERCENT = 44.25; // UPS default, effective 2026-08-17
export const DEFAULT_FSC_PERCENT_DHL = 42.00; // DHL default, effective 2026-08-17
export const DEFAULT_FSC_PERCENT_FEDEX = 43.50; // FedEx default, effective 2026-08-17
